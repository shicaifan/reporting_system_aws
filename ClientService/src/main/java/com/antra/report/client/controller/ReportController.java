...
public class ReportController {
    ...
    @DeleteMapping("/report/content/delete/{reqId}/{type}")
//    @RequestMapping(value = "/report/content/delete/{reqId}/{type}", method = RequestMethod.POST)
    public void deleteReport(@PathVariable String reqId, @PathVariable FileType type, HttpServletResponse response) {
        log.debug("Got Request to Delete File - type: {}, reqid: {}", type, reqId);
        reportService.deleteReport(reqId, type);
        response.setHeader("Content-Type", "text/html");
    }

    //   @PutMapping
//    @PutMapping("/report/content/sqsResponse")
//    public ResponseEntity<GeneralResponse> updateReport(SqsResponse sqsResponse){
//        reportService.updateAsyncExcelReport(sqsResponse);
//        return ResponseEntity.ok(new GeneralResponse());
//    }
