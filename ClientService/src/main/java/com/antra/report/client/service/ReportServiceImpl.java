...
//    CompletableFuture<String> future = es.submit(new MyCallableClass());
//    String result = future.get();
    ...
    @Override
    public HttpStatus deleteReport(String reqId, FileType type){
        ...
        if (type == FileType.PDF) {
            ...
            ResponseEntity<Resource> exchange = restTemplate.exchange("http://localhost:8888/excel/{id}",
...
//    @Transactional // why this? email could fail
    public void updateAsyncPDFReport(SqsResponse response) {
        ...
        String to = "shicaifan412@gmail.com";
